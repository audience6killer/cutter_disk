...
#define CUTTER_PWM_A                GPIO_NUM_18//GPIO_NUM_4
#define CUTTER_PWM_B                GPIO_NUM_19//GPIO_NUM_5
#define CUTTER_ENA_A                GPIO_NUM_20//GPIO_NUM_6
#define CUTTER_ENA_B                GPIO_NUM_21//GPIO_NUM_7

#define LINEAR_MOTOR_PWM_A          GPIO_NUM_22//GPIO_NUM_17
#define LINEAR_MOTOR_PWM_B          GPIO_NUM_23//GPIO_NUM_18
#define LINEAR_MOTOR_ENA_A          GPIO_NUM_25//GPIO_NUM_8//GPIO_NUM_10
#define LINEAR_MOTOR_ENA_B          GPIO_NUM_26//GPIO_NUM_9//GPIO_NUM_11
#define LINEAR_SENSOR_UP            GPIO_NUM_27//GPIO_NUM_10//GPIO_NUM_12
#define LINEAR_SENSOR_DW            GPIO_NUM_32//GPIO_NUM_11//GPIO_NUM_13
